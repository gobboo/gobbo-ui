...
function GOBBO.DrawRoundedBoxEx(borderSize, x, y, w, h, col, topLeft, topRight, bottomLeft, bottomRight)
...
local drawRoundedBoxEx = GOBBO.DrawRoundedBoxEx
function GOBBO.DrawRoundedBox(borderSize, x, y, w, h, col)
...
function GOBBO.DrawFullRoundedBoxEx(borderSize, x, y, w, h, col, tl, tr, bl, br)
	setDrawColor(col.r, col.g, col.b, col.a)
...
function GOBBO.DrawFullRoundedBox(borderSize, x, y, w, h, col)
	return GOBBO.DrawFullRoundedBoxEx(borderSize, x, y, w, h, col, true, true, true, true)
end