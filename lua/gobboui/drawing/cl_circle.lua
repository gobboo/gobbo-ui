...
do
    ...
    local max = math.max
    function GOBBO.DrawCircle(x, y, w, h, col)
        local size = max(w, h)
        ...
        GOBBO.DrawImage(x, y, w, h, id, col)
    end
end
...
do
    ...
    function GOBBO.CreateCircle(x, y, ang, seg, pct, radius)
        local circle = {}
...
local createCircle = GOBBO.CreateCircle
local drawPoly = surface.DrawPoly
function GOBBO.DrawCircleUncached(x, y, ang, seg, pct, radius)
