...
--- @class GOBBO.ComboBox : GOBBO.TextButton
local PANEL = {}
...
function PANEL:PerformLayout(w, h)
    ...
    self:SizeToText()
    self:SetWide(self:GetWide() + GOBBO.Scale(14))
end
...
function PANEL:ChooseOption(value, index)
    ...
    if not self:GetSizeToText() then return end
    self:SizeToText()
    self:SetWide(self:GetWide() + GOBBO.Scale(10))
end
...
function PANEL:OpenMenu(pControlOpener)
    ...
    CloseDermaMenus()
    self.Menu = vgui.Create("GOBBO.Menu", self)
    ...
    self.Menu:Open(x, y + GOBBO.Scale(6), false, self)
...
function PANEL:PaintOver(w, h)
    ...
    GOBBO.DrawImage(w - dropBtnSize - GOBBO.Scale(8), h / 2 - dropBtnSize / 2, dropBtnSize, dropBtnSize, "https://pixel-cdn.lythium.dev/i/5r7ovslav", GOBBO.Colors.PrimaryText)
end

vgui.Register("GOBBO.ComboBox", PANEL, "GOBBO.TextButton")