...
--- @class GOBBO.ScrollbarGrip : Panel
local PANEL = {}

function PANEL:Init()
    self.NormalCol = GOBBO.Colors.Scroller
    self.HoverCol = GOBBO.OffsetColor(self.NormalCol, 15)

    self.Colour = GOBBO.CopyColor(self.NormalCol)
end
...
function PANEL:Paint(w, h)
    self.Colour = GOBBO.LerpColor(FrameTime() * 12, self.Colour,
        (self:IsHovered() or self:GetParent().Dragging) and self.HoverCol or self.NormalCol
    )

    GOBBO.DrawRoundedBox(w / 2, 0, 0, w, h, self.Colour)
end

vgui.Register("GOBBO.ScrollbarGrip", PANEL, "Panel")

--- @class GOBBO.Scrollbar : Panel
PANEL = {}
...
function PANEL:Init()
    ...
    self.BackgroundCol = GOBBO.OffsetColor(GOBBO.Colors.Background, 5)

    self.Scrollbar = vgui.Create("GOBBO.ScrollbarGrip", self)
...
function PANEL:Paint(w, h)
    GOBBO.DrawRoundedBox(w / 2, 0, 0, w, h, self.BackgroundCol)
end

vgui.Register("GOBBO.Scrollbar", PANEL, "Panel")