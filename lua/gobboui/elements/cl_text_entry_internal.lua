...
--- @class GOBBO.TextEntryInternal : TextEntry
local PANEL = {}
...
GOBBO.RegisterFont("UI.TextEntry", "Open Sans SemiBold", 18)
...
function PANEL:Init()
    ...
    self:SetTall(GOBBO.Scale(34))

    self.m_bLoseFocusOnClickAway = true

    self:SetCursor("beam")
    self:SetFontInternal(GOBBO.GetRealFont("UI.TextEntry"))
end
...
function PANEL:Paint(w, h)
    self:DrawTextEntryText(color_white, GOBBO.Colors.Primary, GOBBO.Colors.Primary)
end
...
vgui.Register("GOBBO.TextEntryInternal", PANEL, "TextEntry")