...
--- @class GOBBO.LabelledCheckbox : Panel
local PANEL = {}

function PANEL:Init()
    self.Checkbox = vgui.Create("GOBBO.Checkbox", self)
    ...
    self.Label = vgui.Create("GOBBO.Label", self.LabelHolder)
...
function PANEL:PerformLayout(w, h)
    ...
    self.Checkbox:DockMargin(0, 0, GOBBO.Scale(6), 0)
...
vgui.Register("GOBBO.LabelledCheckbox", PANEL, "Panel")