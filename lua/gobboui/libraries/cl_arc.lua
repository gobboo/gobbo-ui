...
function GOBBO.DrawUncachedArc(cx, cy, radius, thickness, startang, endang, roughness, color)
    surface.SetDrawColor(color)
    GOBBO.DrawArc(GOBBO.PrecacheArc(cx, cy, radius, thickness, startang, endang, roughness))
end

function GOBBO.PrecacheArc(cx, cy, radius, thickness, startang, endang, roughness)
    local triarc = {}
