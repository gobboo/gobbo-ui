...
vgui.Register("GOBBO.Query", PANEL, "GOBBO.Frame")

GOBBO.UI.Overrides.Derma_Query = GOBBO.UI.Overrides.Derma_Query or Derma_Query

Derma_Query = GOBBO.UI.CreateToggleableOverride(GOBBO.UI.Overrides.Derma_Query, function(text, title, ...)
    local msg = vgui.Create("GOBBO.Query")
    msg:SetTitle(title)
    msg:SetText(text)
