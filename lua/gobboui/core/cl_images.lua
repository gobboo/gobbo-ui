...
file.CreateDir(GOBBO.DownloadPath)
...
function GOBBO.GetImage(url, callback, matSettings)
    ...
    local dirPath = GOBBO.DownloadPath .. urlWithoutFileName
    local filePath = GOBBO.DownloadPath .. urlWithoutProtocol
...
function GOBBO.GetImgur(id, callback, _, matSettings)
    local url = "https://i.imgur.com/" .. id .. ".png"
    GOBBO.GetImage(url, callback, matSettings)
end
